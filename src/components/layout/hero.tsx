        ...
        <div className="flex flex-col items-start justify-start gap-8 md:gap-20 md:py-5">
          <div className="flex flex-col items-start justify-start gap-3 md:gap-5">
            <h1 className="display-text-m lg:display-text-lg xl:display-text flex items-start justify-start gap-4 text-foreground">
              ...
              <span className="font-extrabold ">Godwin</span>
            </h1>
          ...
          <p className={`paragraph2 md:mb-4 text-zinc-500`}>
            I&apos;m Godwin, a passionate full-stack web developer with a strong focus on building
            clean, scalable, and user-friendly applications using Next.js, TypeScript, and Tailwind
            CSS. I enjoy turning complex problems into elegant solutions, often blending backend
            logic with refined frontend design. I'm also exploring DevOps practices and automation
            to boost productivity. Currently, I&apos;m working on several real-world projects that
            reflect my commitment to code quality and continuous learning.
          </p>
